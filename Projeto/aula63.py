...
cpf = re.sub( # It will substitute something from somewhere
   r'[^0-9]', # Here I will substitute what is not a number between 0 and 9
...
nine_digits = cpf[:9]
# So let's refactor the entire code of class 62 (OMG)
...
new_cpf = nine_digits + str(cpf_first_digit) + str(cpf_second_digit)
# print(new_cpf)
